...
Public Class frmCustomersRecord3
    ...
    Public Function GetData() As DataView
        Dim SelectQry = "SELECT (customerNo) as [Customer ID],(B_name) as [B_Name],(b_address) as [B_Address],(b_city) as [B_City],(b_state) as [B_State],(b_zipcode) as [B_Zip/Post Code],(Phone) as [Phone],(email)as [Email],(mobileno) as [Mobile No],(notes)as [Notes],(addedby)as [Registered By] from Customer order by CustomerNo"
    ...
    Private Sub txtCustomer_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCustomer.TextChanged
        Try
            ...
            con.Open()
            cmd = New OleDbCommand("SELECT (customerNo) as [Customer ID],(B_name) as [B_Name],(b_address) as [B_Address],(b_city) as [B_City],(b_state) as [B_State],(b_zipcode) as [B_Zip/Post Code],(Phone) as [Phone],(email)as [Email],(mobileno) as [Mobile No],(notes)as [Notes],(addedby)as [Registered By] from Customer where B_Name like '" & txtCustomer.Text & "%'  order by CustomerNo", con)
    ...
    Private Sub txtName_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtName.SelectedIndexChanged
        Try
            con = New OleDbConnection(cs)
            con.Open()
            cmd = New OleDbCommand("SELECT (customerNo) as [Customer ID],(B_name) as [B_Name],(b_address) as [B_Address],(b_city) as [B_City],(b_state) as [B_State],(b_zipcode) as [B_Zip/Post Code],(Phone) as [Phone],(email)as [Email],(mobileno) as [Mobile No],(notes)as [Notes],(addedby)as [Registered By] from Customer where B_Name = '" & txtName.Text & "' order by CustomerNo", con)
