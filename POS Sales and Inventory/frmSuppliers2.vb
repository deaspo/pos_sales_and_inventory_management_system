...
Public Class frmSuppliers2
    ...
    Private Sub txtName_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtName.SelectedIndexChanged
        Try
            con = New OleDbConnection(cs)
            con.Open()
            cmd = New OleDbCommand("SELECT (supplierNo) as [Supplier ID],(SupplierName)as [Supplier Name] from Suppliers where SupplierName like = '" & txtName.Text & "' order by SupplierNo", con)
