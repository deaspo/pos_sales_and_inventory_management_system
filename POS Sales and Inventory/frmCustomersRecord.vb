...
Public Class frmCustomersRecord
    ...
    Public Function GetData() As DataView
        Dim SelectQry = "SELECT (customerNo) as [Customer ID],(B_name) as [B_Name],(b_address) as [B_Address],(b_city) as [B_City],(b_state) as [B_State],(b_zipcode) as [B_Zip/Post Code],(Phone) as [Phone],(email)as [Email],(mobileno) as [Mobile No],(notes)as [Notes] from Customer order by customerno"
